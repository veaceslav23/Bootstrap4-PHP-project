...
<div class="container-fluid">
  ...
  <div class="form-row p-2">
    ...
    <span class="text-center text-danger">  <?php echo $nameErr;?></span>
    <input type="text" name="name" class="form-control">
  </div>
  <div class="form-row p-2">
    <label for="login">Username</label><br>
    <span class="text-center text-danger"><?php echo $loginErr;?></span>
    <input type="text" name="login" class="form-control">
  </div>
  <div class="form-row p-2">
    <label for="email">Email address</label>
    <span class="text-center text-danger"><?php echo $mailErr;?></span>
    <input type="email" name="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
  <div class="form-row p-2">
    <label for="password">Password</label><br>
    <span class="text-center text-danger"><?php echo $passwordErr;?></span>
    <input type="password" name="password" class="form-control">
  </div>
  <div class="form-row-last pt-4">
  <input type="submit" class="btn btn-primary btn-sm w-100 d-block mx-auto rounded p-3" value="Submit">
</div>
<div class="form-row-last pt-4">
  <h6 class="text-center">Already a member? <a href="login.php" class="d-inline-block mx-auto">Log In</a></h6>
</div>
</form>
</div>
