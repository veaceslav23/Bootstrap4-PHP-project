...
<nav class="navbar navbar-expand-lg sticky-top">
  <a class="navbar-brand" href="landing.php">
    <img src="slava1.png" width="250" height="70" class="txt-brand"  alt="" loading="lazy">
  </a>
  ...
  <div class="collapse navbar-collapse justify-content-end" id="navbarTogglerDemo03">
    <ul class="navbar-nav">
      <li class="nav-item active">
        <a class="form-control btn btn-danger btn-lg my-2 my-sm-0" href="login.php">LOG IN</a>
      </li>
    </ul>
  </div>
</nav>
<div class="container-fluid w-100">
    ...
    <button class="btn btn-danger sign" onclick="location.href='signup.php';" >Sign Up</button>
  </div>
  </div>
</div>
	</div>
